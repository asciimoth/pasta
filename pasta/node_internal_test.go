...
func (n *internalNode) OnInit(w *Workspace, l Logger, id uint64, class string, restored *NodeInitData, isReplacement bool, isPlaceholderReplacement bool, isClassConstructed bool, isRestored bool) error {
	n.call("init")
	return nil
}
